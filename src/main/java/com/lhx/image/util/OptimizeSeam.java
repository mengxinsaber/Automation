 ...
 */
public class OptimizeSeam {

    private static Logger logger = LoggerFactory.getLogger(OptimizeSeam.class);
    ...
    void CalcCorners(Mat H, Mat src)
    {
        ...
        Mat V2 = new Mat(3, 1, CvType.CV_64FC1);  //列向量
        Mat V1 = new Mat(3, 1, CvType.CV_64FC1);  //列向量
//        Mat V1 = Mat(3, 1, CV_64FC1, v1);

        Core.multiply(V2,H,V1); //        H * V2;
        ...
        v2[1] = src.rows();
        v2[2] = 1;
        V2 = new Mat(3, 1, CvType.CV_64FC1, v2.);  //列向量
